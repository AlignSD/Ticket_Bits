          ...
          <div className={classes.form}>
            <form
              ...
              onSubmit={(event) => {
                ...
                const eventCheck = eventModel.methods
                  .createEvent(
                    name,
                    start,
                    end,
            ...
            >
              <div style={{ backgroundColor: "transparent" }}>
                ...
                >
                  Name your event and tell the event-goers why they should come.
                  Add details that highlight what makes it unique.
                </Typography>
                <TextField
                  name="Event Name"
                  className="outlined-margin-none"
                  id="EventName"
                  label="Event Name *"
                  style={{ padding: 6 }}
                  fullWidth
                ...
                <TextField
                  ...
                  variant="outlined"
                  onChange={(e) =>
                    setModelStart({ start: parseInt(e.target.value, 0) })
                  }
                />
                <TextField
                  className="outlined-margin-none"
                  ...
                  variant="outlined"
                  onChange={(e) =>
                    setModelEnd({ end: parseInt(e.target.value, 0) })
                  }
                />
                <TextField
                  className="outlined-margin-none"
                  ...
                  variant="outlined"
                  onChange={(e) =>
                    setModelAmount({ amount: parseInt(e.target.value, 0) })
                  }
                />
                <TextField
                  className="outlined-margin-none"
                  ...
                  variant="outlined"
                  onChange={(e) =>
                    setModelPrice({ price: parseInt(e.target.value, 0) })
                  }
                />
                <TextField
                  className="outlined-margin-none"
